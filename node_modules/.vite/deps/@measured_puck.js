    ...
    !(function(e3) {
      ...
      return (function r3(o2, i2, u3) {
        ...
        !(function(e3, n3, s2, c3, d2, h2, p2, g2, y2) {
          ...
          m2.writeToStream = function(e4, t4, n4) {
        ...
        !(function(e4, t4, n3, r3, o2, i2, u3, s2, a2) {
          !(function(e5) {
            ...
            e5.toByteArray = function(e6) {
              ...
              for (t6 = 0; t6 < i4; t6 += 4, 0) s4((16711680 & (n5 = f4(e6.charAt(t6)) << 18 | f4(e6.charAt(t6 + 1)) << 12 | f4(e6.charAt(t6 + 2)) << 6 | f4(e6.charAt(t6 + 3)))) >> 16), s4((65280 & n5) >> 8), s4(255 & n5);
        ...
        !(function(e4, n3, f3, r3, h2, p2, g2, y2, w2) {
          ...
          function f3(e5, t4, n4) {
            if (!(this instanceof f3)) return new f3(e5, t4, n4);
            ...
            else if ("string" == s3) r4 = f3.byteLength(e5, t4);
            else {
              if ("object" != s3) throw new Error("First argument needs to be a number, array or string.");
              r4 = j(e5.length);
            }
            if (f3._useTypedArrays ? o3 = f3._augment(new Uint8Array(r4)) : ((o3 = this).length = r4, o3._isBuffer = true), f3._useTypedArrays && "number" == typeof e5.byteLength) o3._set(e5);
            else if (C(u4 = e5) || f3.isBuffer(u4) || u4 && "object" == typeof u4 && "number" == typeof u4.length) for (i3 = 0; i3 < r4; i3++) f3.isBuffer(e5) ? o3[i3] = e5.readUInt8(i3) : o3[i3] = e5[i3];
            else if ("string" == s3) o3.write(e5, 0, t4);
            else if ("number" == s3 && !f3._useTypedArrays && !n4) for (i3 = 0; i3 < r4; i3++) o3[i3] = 0;
            return o3;
          }
          ...
          H.Buffer = f3, H.SlowBuffer = f3, H.INSPECT_MAX_BYTES = 50, f3.poolSize = 8192, f3._useTypedArrays = (function() {
            ...
            if (d2(C(e5), "Usage: Buffer.concat(list, [totalLength])\nlist should be an Array."), 0 === e5.length) return new f3(0);
            ...
            if (t4 = t4 || 0, (r4 = r4 || 0 === r4 ? r4 : this.length) !== (n4 = n4 || 0) && 0 !== e5.length && 0 !== this.length) {
              ...
              if (o3 < 100 || !f3._useTypedArrays) for (var i3 = 0; i3 < o3; i3++) e5[i3 + t4] = this[i3 + n4];
              else e5._set(this.subarray(n4, n4 + o3), t4);
            }
          }, f3.prototype.slice = function(e5, t4) {
            var n4 = this.length;
            if (e5 = S2(e5, n4, 0), t4 = S2(t4, n4, n4), f3._useTypedArrays) return f3._augment(this.subarray(e5, t4));
            for (var r4 = t4 - e5, o3 = new f3(r4, void 0, true), i3 = 0; i3 < r4; i3++) o3[i3] = this[i3 + e5];
            return o3;
            ...
            return E(this, e5, true, t4);
          }, f3.prototype.readInt32BE = function(e5, t4) {
            return E(this, e5, false, t4);
            ...
            if (f3._useTypedArrays) return new f3(this).buffer;
        ...
        !(function(e4, t3, a2, n3, r3, o2, i2, u3, s2) {
          ...
          d2.exports = { hash: function(e5, t4, n4, r4) {
            for (var o3 = t4((function(e6, t5) {
              ...
              for (var n5, r5 = [], o4 = t5 ? e6.readInt32BE : e6.readInt32LE, i4 = 0; i4 < e6.length; i4 += f3) r5.push(o4.call(e6, i4));
              return r5;
        ...
        !(function(l2, c3, u3, d2, h2, p2, g2, y2, w2) {
          ...
          var o2, f3 = ["createCredentials", "createCipher", "createCipheriv", "createDecipher", "createDecipheriv", "createSign", "createVerify", "createDiffieHellman", "pbkdf2"], m2 = function(e5) {
            _2[e5] = function() {
              i2("sorry,", e5, "is not implemented yet");
            };
          };
          for (o2 in f3) m2(f3[o2], o2);
          ...
          function u3(l3, c4) {
            ...
            for (var e5, t4, n4, r4 = Array(80), o3 = 1732584193, i3 = -271733879, u4 = -1732584194, s3 = 271733878, d3 = -1009589776, h2 = 0; h2 < l3.length; h2 += 16) {
              for (var p2 = o3, g2 = i3, y2 = u4, w2 = s3, b2 = d3, a3 = 0; a3 < 80; a3++) {
                ...
                var f4 = m2(m2(v2(o3, 5), (f4 = i3, t4 = u4, n4 = s3, (e5 = a3) < 20 ? f4 & t4 | ~f4 & n4 : !(e5 < 40) && e5 < 60 ? f4 & t4 | f4 & n4 | t4 & n4 : f4 ^ t4 ^ n4)), m2(m2(d3, r4[a3]), (e5 = a3) < 20 ? 1518500249 : e5 < 40 ? 1859775393 : e5 < 60 ? -1894007588 : -899497514)), d3 = s3, s3 = u4, u4 = v2(i3, 30), i3 = o3, o3 = f4;
              }
              o3 = m2(o3, p2), i3 = m2(i3, g2), u4 = m2(u4, y2), s3 = m2(s3, w2), d3 = m2(d3, b2);
            }
        ...
        !(function(e4, t3, n3, r3, u3, s2, a2, f3, l2) {
          ...
          function o2(e5, l3) {
            ...
            for (var r4, o3, h2 = 0; h2 < e5.length; h2 += 16) {
              for (var i3 = t4[0], u4 = t4[1], s3 = t4[2], p2 = t4[3], a3 = t4[4], g2 = t4[5], y2 = t4[6], w2 = t4[7], f4 = 0; f4 < 64; f4++) n4[f4] = f4 < 16 ? e5[f4 + h2] : b2(b2(b2((o3 = n4[f4 - 2], m2(o3, 17) ^ m2(o3, 19) ^ v2(o3, 10)), n4[f4 - 7]), (o3 = n4[f4 - 15], m2(o3, 7) ^ m2(o3, 18) ^ v2(o3, 3))), n4[f4 - 16]), c4 = b2(b2(b2(b2(w2, m2(o3 = a3, 6) ^ m2(o3, 11) ^ m2(o3, 25)), a3 & g2 ^ ~a3 & y2), d3[f4]), n4[f4]), r4 = b2(m2(r4 = i3, 2) ^ m2(r4, 13) ^ m2(r4, 22), i3 & u4 ^ i3 & s3 ^ u4 & s3), w2 = y2, y2 = g2, g2 = a3, a3 = b2(p2, c4), p2 = s3, s3 = u4, u4 = i3, i3 = b2(c4, r4);
          ...
          var i2 = c3("./helpers"), m2 = function(e5, t4) {
            return e5 >>> t4 | e5 << 32 - t4;
          }, v2 = function(e5, t4) {
            return e5 >>> t4;
          };
...
// node_modules/@measured/puck/dist/chunk-OOLYDXKW.mjs
...
// node_modules/@measured/puck/dist/chunk-QIGVND56.mjs
...
d.prototype.S = function(i2) {
  ...
  if (n3 !== i2 && void 0 === i2.e) {
    i2.x = n3;
    this.t = i2;
    if (void 0 !== n3) n3.e = i2;
    else o(function() {
      var i3;
...
var CollisionObserver = class extends Plugin {
  ...
  constructor(manager) {
    ...
    __privateSet3(this, _collisions, c(DEFAULT_VALUE));
...
var __runInitializers5 = (array, flags, self2, value) => {
  for (var i2 = 0, fns = array[flags >> 1], n3 = fns && fns.length; i2 < n3; i2++) fns[i2].call(self2);
  return value;
};
...
function c2(u3, e3, c3) {
  var i2 = this, a2 = (0, import_react10.useRef)(null), o2 = (0, import_react10.useRef)(0), f3 = (0, import_react10.useRef)(null), l2 = (0, import_react10.useRef)([]), m2 = (0, import_react10.useRef)(), v2 = (0, import_react10.useRef)(), d2 = (0, import_react10.useRef)(u3), p2 = (0, import_react10.useRef)(true);
  ...
  var h2 = (0, import_react10.useMemo)(function() {
    var r3 = function(r4) {
      var n4 = l2.current, t4 = m2.current;
      return l2.current = m2.current = null, o2.current = r4, v2.current = d2.current.apply(t4, n4);
    }, n3 = function(r4, n4) {
      ...
      return f3.current = null, s2 && l2.current ? r3(n4) : (l2.current = m2.current = null, v2.current);
    }, c4 = function r4() {
      var c5 = Date.now();
      ...
      if (l2.current = [].slice.call(arguments), m2.current = i2, a2.current = u5, d3) {
        if (!f3.current && p2.current) return o2.current = a2.current, n3(c4, e3), w2 ? r3(a2.current) : v2.current;
        if (x) return n3(c4, e3), r3(a2.current);
      }
      return f3.current || n3(c4, e3), v2.current;
    };
    return h3.cancel = function() {
      f3.current && (g2 ? cancelAnimationFrame(f3.current) : clearTimeout(f3.current)), o2.current = 0, l2.current = a2.current = m2.current = f3.current = null;
...
@measured/puck/dist/chunk-QIGVND56.mjs:
  (*! Bundled license information:
